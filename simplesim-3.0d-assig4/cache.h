...
typedef struct stride_entry_t {
  int tag;//use lower 20 bits to store as tag
  md_addr_t prev_addr;
  int stride;
  short state; // initial = 0, transient = 1, steady = 2, no-prediction = 3
} stride_entry;
